...
export interface CombatRules {
  ...
  sectorUnit: number;
  /** Доля корпуса, с которой пилот возвращается после гибели (M15.7). */
  deathHullShare?: number;
  /** Сколько единиц корпуса в минуту чинит стоянка в доке (M15.7); 0 — только за деньги. */
  dockRepairPerMinute?: number;
}
