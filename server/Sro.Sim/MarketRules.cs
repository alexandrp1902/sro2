    ...
    MarketDemand? Demand = null)
{
    ...
    /// <summary>
    /// Продаёт ли станция этот товар. С M16a — всё, чем торгует: что лежит на складе, то и можно купить.
    ...
    /// привезти просят только то, чего здесь не производят, — иначе задание сдавалось бы покупкой
    /// в соседней вкладке (M12).
    /// </summary>
    public bool Makes(string good) => Trades(good) && Role(good) == MarketRole.Produces;
