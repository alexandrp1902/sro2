...
public sealed partial class Room
{
    ...
    private void EndRun(int playerId)
    {
        ...
        // Конвой и звено перестали быть кораблями задания — ростер должен узнать об этом сразу, а не
        // при следующем случайном событии: до тех пор они так и рисуются своими картинками.
        BroadcastPlayers();
    }
