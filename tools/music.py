...
арпеджио, в бою вместо них поднимаются боевые слои, а на станции и на планете музыки нет вовсе — только
тишина под крышей. Поэтому «бой начался» — это не смена трека с паузой и не склейка, а изменение
громкостей за полсекунды.
